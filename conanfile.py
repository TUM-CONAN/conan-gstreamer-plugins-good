...
class GStreamerPluginsGoodConan(ConanFile):
    ...
    options = {
        ...
        "v4l2": [True, False],
        "v4l2probe": [True, False],
        "v4l2libv4l2": [True, False],
    }
    ...
    def build(self):
        ...
        args.append("-Dv4l2-probe=" + ("enabled" if self.options.v4l2probe else "disabled"))
        args.append("-Dv4l2-libv4l2=" + ("enabled" if self.options.v4l2libv4l2 else "disabled"))
        meson = Meson(self)
